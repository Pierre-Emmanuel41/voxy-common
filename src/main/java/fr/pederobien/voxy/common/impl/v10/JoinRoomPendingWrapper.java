...
public class JoinRoomPendingWrapper implements IWrapper {

	@Override
	public byte[] getBytes(Object payload) {
		if (!(payload instanceof JoinRoomPendingRequest))
			throw new IllegalArgumentException("[JoinRoomPendingWrapper] - The payload data type shall be JoinRoomPendingRequest");

		JoinRoomPendingRequest request = (JoinRoomPendingRequest) payload;
	...
	public Object parse(byte[] data) {
		...
		return new JoinRoomPendingRequest(roomName, playerName);
	}
